...
% KnnIndex  = randperm(VertexLen);
KnnIndex    = 1:VertexLen/3 ; %% KnnIndex(1:floor(VertexLen/5));
% KnnIndex    = 1:0 ; %% KnnIndex(1:floor(VertexLen/5));
...
for i = 1:100
    ...
    for j=1:10
        ...
        %[ JacobianReg  , LossReg  ] =  JacobianRegFunc_RTEqual (canonical_xyz, line2    , Twist);
